...
const pagesComponents = {
  ...
  "v-24600ac6": vue.defineAsyncComponent(() => Promise.resolve().then(function() {
    return guide_html$2;
  })),
...
const pagesData$1 = {
  ...
  "v-24600ac6": () => Promise.resolve().then(function() {
    return guide_html;
  }).then(({ data: data2 }) => data2),
...
const routeItems = [
  ...
  ["v-24600ac6", "/components/guide.html", { "title": "input-text" }, ["/components/guide", "/components/guide.md"]],
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="my-component-library" tabindex="-1"><a class="header-anchor" href="#my-component-library" aria-hidden="true">#</a> My Component library</h1><p>Here&#39;s a brief introduction.</p><h3 id="installation" tabindex="-1"><a class="header-anchor" href="#installation" aria-hidden="true">#</a> Installation</h3><p>$ npm install @maryamnoor/tile-component-library</p><!--]-->`);
}
...
var index_html$1 = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["ssrRender", _sfc_ssrRender$3]]);
...
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("../pages/components/guide.html.vue");
  return _sfc_setup$m ? _sfc_setup$m(props, ctx) : void 0;
};
var guide_html$1 = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["ssrRender", _sfc_ssrRender$2]]);
...
const data$1 = {
  ...
  "headers": [],
  "git": {},
  "filePathRelative": "components/guide.md"
};
